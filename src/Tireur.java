...
public class Tireur extends Robot {
	...
	public boolean peutTirer(Coordonnees c) {
		...
		boolean portee_haute = (resultat.getHauteur() <= Constante.PORTEETIREUR && resultat
				.getLargeur() == 0) ? true : false;
		boolean portee_basse = (resultat.getHauteur() >= -Constante.PORTEETIREUR && resultat
				.getLargeur() == 0) ? true : false;
		boolean portee_gauche = (resultat.getLargeur() >= -Constante.PORTEETIREUR && resultat
				.getHauteur() == 0) ? true : false;
		boolean portee_droite = (resultat.getLargeur() <= Constante.PORTEETIREUR && resultat
				.getHauteur() == 0) ? true : false;
