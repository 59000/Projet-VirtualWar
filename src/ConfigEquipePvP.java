...
public class ConfigEquipePvP {
	...
	public ConfigEquipePvP(){
		...
		final JTextField textNomEquipe1 = new JTextField("Equipe 1 : Entrez un nom ");
		...
		((JLabel)gaucheR0.getRenderer()).setHorizontalAlignment(SwingConstants.CENTER);
		gaucheR0.addItem("------------");
		...
		((JLabel)gaucheR1.getRenderer()).setHorizontalAlignment(SwingConstants.CENTER);
		gaucheR1.addItem("------------");
		...
		((JLabel)gaucheR2.getRenderer()).setHorizontalAlignment(SwingConstants.CENTER);
		gaucheR2.addItem("------------");
		...
		((JLabel)gaucheR3.getRenderer()).setHorizontalAlignment(SwingConstants.CENTER);
		gaucheR3.addItem("------------");
		...
		((JLabel)gaucheR4.getRenderer()).setHorizontalAlignment(SwingConstants.CENTER);
		gaucheR4.addItem("------------");
		...
		final JTextField textNomEquipe2 = new JTextField("Equipe 2 : Entrez un nom ");
		...
		((JLabel)droitR0.getRenderer()).setHorizontalAlignment(SwingConstants.CENTER);
		droitR0.addItem("------------");
		...
		((JLabel)droitR1.getRenderer()).setHorizontalAlignment(SwingConstants.CENTER);
		droitR1.addItem("------------");
		...
		((JLabel)droitR2.getRenderer()).setHorizontalAlignment(SwingConstants.CENTER);
		droitR2.addItem("------------");
		...
		((JLabel)droitR3.getRenderer()).setHorizontalAlignment(SwingConstants.CENTER);
		droitR3.addItem("------------");
		...
		((JLabel)droitR4.getRenderer()).setHorizontalAlignment(SwingConstants.CENTER);
		droitR4.addItem("------------");
		...
		valider.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				// TODO Auto-generated method stub
				/*Mettre toutes les conditions pour jouer : mettre un nom dequipe, avoir le meme nombre de robot de
				 * chaque cote
				 * */
